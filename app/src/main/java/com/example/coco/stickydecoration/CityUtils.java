...
/**
 * Created by coco on 2017/10/30.
 */

public class CityUtils {
    public static List<City> getCityList() {
        List<City> dataList = new ArrayList<>();
        final String FU_JIAN = "山西省";
        final int FU_JIAN_ICON = R.mipmap.ic_launcher_round;
        dataList.add(new City("太原", FU_JIAN, FU_JIAN_ICON));
        dataList.add(new City("平遥", FU_JIAN, FU_JIAN_ICON));
        dataList.add(new City("吕梁", FU_JIAN, FU_JIAN_ICON));
        dataList.add(new City("运城", FU_JIAN, FU_JIAN_ICON));
        dataList.add(new City("榆次", FU_JIAN, FU_JIAN_ICON));
